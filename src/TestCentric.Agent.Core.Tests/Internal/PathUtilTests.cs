...
namespace TestCentric.Engine.Internal
{
	...
	public class PathUtilTests_Windows
	{
        ...
        public void RelativePath()
		{
			...
			Assert.That(PathUtils.RelativePath( @"C:\folder", @"D:\folder"), Is.Null,	"Unrelated paths should return null" );
            Assert.That(PathUtils.RelativePath(@"C:\", @"D:\"), Is.Null, "Unrelated roots should return null");
            Assert.That(PathUtils.RelativePath(@"C:", @"D:"), Is.Null, "Unrelated roots (no trailing separators) should return null");
