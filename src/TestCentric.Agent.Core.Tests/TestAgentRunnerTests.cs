...
namespace TestCentric.Engine.Runners
{
    ...
    public class TestAgentRunnerTests<TRunner> where TRunner : TestAgentRunner
    {
        ...
        public void Initialize()
        {
            ...
            // TODO: Add necessary settings directly
            //packageSettingsService.ApplyImageSettings(_package);

            // HACK: Depends on the fact that all TestAgentRunners support this constructor
            _runner = Activator.CreateInstance(typeof(TRunner), _package) as TRunner;
        }
